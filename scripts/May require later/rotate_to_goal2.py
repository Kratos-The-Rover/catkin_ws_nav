...
class husky_controller():
	...
	def odom_cb(self,data):
		...
		x_diff=self.dest_x-self.curr_x
		y_diff=self.dest_y-self.curr_y
		self.dest_yaw=math.atan2(y_diff,x_diff)
		...
		if((abs(self.current_yaw-self.dest_yaw)>0.1)):
			...
			twist_obj.angular.z=self.kp*(self.current_yaw-self.dest_yaw)*(-1)
